...
public final class BarUtils {
    ...
    public static int getStatusBarHeight() {
        Resources resources = CommonBaseApplication.context.getResources();
    ...
    public static int getActionBarHeight() {
        ...
        if (CommonBaseApplication.context.getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, CommonBaseApplication.context.getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = CommonBaseApplication.context.getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = CommonBaseApplication.context.getResources();
    ...
    private static String getResNameById(int id) {
        try {
            return CommonBaseApplication.context.getResources().getResourceEntryName(id);
    ...
    public static boolean isSupportNavBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            WindowManager wm = (WindowManager) CommonBaseApplication.context.getSystemService(Context.WINDOW_SERVICE);
        ...
        boolean menu = ViewConfiguration.get(CommonBaseApplication.context).hasPermanentMenuKey();
